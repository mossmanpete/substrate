...
use runtime_primitives::traits::{AuthorityIdFor, Block, ProvideRuntimeApi};
use futures::prelude::*;
...
/// Returns the authorities at a given block.
pub fn authorities<C: ProvideRuntimeApi, B: Block<Hash=H256>>(
	client: &C,
	at: &BlockId<B>
) -> Result<Vec<AuthorityIdFor<B>>, Error> {
	// TODO: FIXME:
	//client.runtime_api().
